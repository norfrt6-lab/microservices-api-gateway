...
import { PrismaClient as UserPrismaClient } from "../services/user-service/generated";
import { PrismaClient as ProductPrismaClient } from "../services/product-service/generated/prisma-client";
...
async function seedProducts() {
  ...
  const products = [
    ...
    {
      name: "4K Monitor",
      description: "27-inch 4K IPS monitor, 60Hz",
      price: 499.99,
      stock: 25,
    },
    {
    ...
    {
      name: "Standing Desk",
      description: "Electric standing desk, 48x30 inch",
      price: 599.99,
      stock: 15,
    },
    {
